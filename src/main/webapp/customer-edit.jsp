...
<form name="form2" id="form2" action="customer-edit" method="post">
...
<td height="28" colspan=4 align=center>
	<a href="javascript:editCustomer()" class="coolbg">保存</a>
	<a href="cumtomer-show?currentPage=${currentPage}" class="coolbg">返回</a>
</td>
</tr>
</table>
</form>
