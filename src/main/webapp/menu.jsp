      ...
      <dl class='bitem'>
		<dt onclick=showHide("items1_1")><b>项目管理</b></dt>
			...
			<ul class='sitemu' id=0>
				...
				<li><a href='project/project-need-show' target='main'>需求分析管理</a> </li>
				<li><a href='project/project-model.jsp' target='main'>模块管理</a> </li>
...
<li><a href='customer/cumtomer-show' target='main'>客户信息</a> </li>
</ul></dd></dl>
