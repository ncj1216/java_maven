...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
        $(function(){
            $.ajax({
                type:'GET',
                url:'project/project-need-project-show?mark=0',
                dataType:'json',
...
<form name="form2" action="project/project-need-saveInfo" method="post" enctype="multipart/form-data"  id="form3">
...
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">需求分析材料: </td>
